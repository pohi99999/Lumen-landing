  ...
  return (
    <main id="main-content" role="main" className="min-h-screen text-[#EAEAEA] selection:bg-[#3A0F14] selection:text-white pb-20">
      ...
      <section className="py-32 px-6">
        <div className="container mx-auto">
          <FadeIn direction="up" className="text-center max-w-3xl mx-auto mb-20 space-y-8">
            ...
            <p className="font-serif text-xl md:text-2xl text-[#C6A15B] italic leading-relaxed">{ t.experience.accent }</p>
          </FadeIn>
      ...
      <section className="py-36 md:py-44 px-6 relative overflow-hidden">
        {/* Finom háttér — a selyemtextúra látszik át, enyhe sötétítéssel */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#0B0B0B]/60 via-[#1a0a0d]/40 to-[#0B0B0B]/60" />
        ...
        <div className="container mx-auto relative z-10 text-center flex flex-col items-center max-w-3xl">
          <FadeIn direction="up">
            ...
            <span className="uppercase tracking-[0.3em] text-[#C6A15B]/80 text-xs md:text-sm mb-10 block font-light">
              { t.exclusivity.label }
            </span>

            {/* Szám — elegánsabb, visszafogottabb méret */}
